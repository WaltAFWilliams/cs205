#!/usr/bin/env python3
# File       : plot.py
# Description: Plot script for Julia Set problem CS205
...
def render_image():
    ...
    try:
        image = np.loadtxt('image.txt', dtype=np.uint16)
...
def render_histogram():
    # Using a simple bar-plot would completely hide the column with iteration
